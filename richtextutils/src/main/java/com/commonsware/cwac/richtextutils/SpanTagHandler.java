 ...
 */
abstract public class SpanTagHandler<T extends CharacterStyle> {
  /**
  ...
  static <T extends CharacterStyle> SpanTagHandler getGlobalSpanTagHandler(Class<T> cls) {
  ...
  static CharacterStyle buildSpanForTag(String name, Attributes a) {
   ...
   * @param <T> the specific CharacterStyle subclass that this handler, um, handles
   */
  abstract public static class Simple<T extends CharacterStyle>
